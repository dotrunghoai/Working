...
Public Class FrmPermissionControl
    ...
    Sub LoadAll()
        ...
        Dim sql As String = String.Format(" select control.ControlName,{1} as ControlText, cast(0 as bit) as 'Check' from Main_ControlRight control " +
                                          " inner join Main_Language lg on lg.ControlName=control.ControlName and lg.FormID=control.FormID " +
                                          " where control.FormID='{0}' ",
                                          ID,
                                          controlText)
        GridControl1.DataSource = db.FillDataTable(sql)
        'Set Permission 
        Dim sqlControl As String = String.Format(" select * from Main_UserRightDetail where userID='{0}' and FormID='{1}' ",
                                                      UserID, ID)
