 ...
 Public Class t_ASProductPrice
     Public ItemCode_K As String 
     Public VendorCode_K As String 
     Public DistributerFlag_K As String 
     Public CurrencyCode_K As String 
     Public IncotermsCode_K As String 
     Public ApplyDate_K As DateTime 
     Public VolumeDiscountQuantity_K As double
