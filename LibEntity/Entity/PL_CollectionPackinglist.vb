 ...
 Public Class PL_CollectionPackinglist
     Public ID As String 
     Public PackNo As String 
     Public PL_K As String 
     ...
     Public SO As String 
     Public CS_PO As String 
     Public Cartons As  Integer 
     Public OK_QTY As  Integer 
     Public NG_QTY As  Integer 
