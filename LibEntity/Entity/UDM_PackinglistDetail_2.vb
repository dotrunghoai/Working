 ...
 Public Class UDM_PackinglistDetail_2
     ...
     Public BoxPerfectQuantity As Decimal 
     Public BoxDefectQuantity As Decimal 
     Public LotNumber2 As String 
     Public PerfectQuantity As Decimal 
     Public DefectQuantity As Decimal 
