...
Public Class FrmCancelList
    ...
    Private Sub mnuShowAll_Click(sender As Object, e As EventArgs) Handles mnuShowAll.Click
        ...
        GridView1.Columns("Loai").Width = 50
    ...
    Private Sub FrmCancelList_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
        dtpStartDate.Value = GetStartDayOfMonth(dtpStartDate.Value)
