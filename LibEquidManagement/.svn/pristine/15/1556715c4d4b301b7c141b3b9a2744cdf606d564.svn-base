...
Public Class FrmAbnormalList
    ...
    Private Sub mnuShowAll_Click(sender As Object, e As EventArgs) Handles mnuShowAll.Click
        Dim sql As String = String.Format("sp_QAE_LoadAbnormal")
    ...
    Private Sub FrmAbnormalList_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
