...
#Region "User function"
    Sub LoadAll()
        ...
        If Not _db.ExistObject(obj) Then
            _db.Insert(obj)
        End If
        Dim sql As String = String.Format("select * from {0} where UserID='{1}' ",
                                          PublicTable.Table_DCS_User, _uID)
...
#End Region
    ...
    Private Sub FrmGroupOfUserSPC_FormClosing(sender As System.Object, e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        ...
        obj.CIS_IQA = GridView1.GetFocusedRowCellValue("CIS_IQA")
        obj.CIS_OQA = GridView1.GetFocusedRowCellValue("CIS_OQA")
        ...
        obj.CIS_IQA_EDIT = GridView1.GetFocusedRowCellValue("CIS_IQA_EDIT")
        obj.CIS_OQA_EDIT = GridView1.GetFocusedRowCellValue("CIS_OQA_EDIT")
        _db.Update(obj)
    End Sub
