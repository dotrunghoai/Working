...
Public Class FrmProcessHourNew : Inherits DevExpress.XtraEditors.XtraForm
    Private DB As DBSql
...
#Region "User Function"
	...
	Private Sub LoadCombox()
		Dim sql As String = " Select distinct ProductCode from PD_ProcessHourNew order by ProductCode"
	...
	Private Sub LoadAll()
		...
		Dim sql As String = String.Format("sp_PD_LoadProcessHourNew")
...
#End Region
	...
	Private Sub gridProcessHour_CellValueChanged(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs)

	End Sub

	Private Sub SetValues(ByRef obj As PD_ProcessHourNew, ByVal rN As Integer)
	...
	Private Sub SetValues(ByRef obj As PD_ProcessHourNew, ByVal r As DataRow)
	...
	Private Sub mnuUpdateOld_Click(sender As Object, e As EventArgs) Handles mnuUpdateOld.Click
