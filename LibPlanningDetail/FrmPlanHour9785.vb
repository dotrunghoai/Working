...
#Region "Form Function"
    ...
    Private Sub KNN_3Ca()
        ...
        Dim sqlrestdate As String = String.Format(
                                    ...
                                    " FROM FPICS_HolidayDate where [HolidayDate]>=getdate() and HolidayDate<=@EndDate and 1=2 ")
    ...
    Private Sub KNN_3Ca_BK()
        ...
        Dim sqlrestdate As String = String.Format(
                                    ...
                                    " DATEADD(second, 0, " +
                                                ...
                                                " DATEADD(month, month([HolidayDate])-1, " +
                                                " DATEADD(Year, year([HolidayDate])-1900, 0)))))) AS ToDate " +
                                    " FROM FPICS_HolidayDate where [HolidayDate]>=getdate() and HolidayDate<=@EndDate")
    ...
    Private Sub CNN_3Ca()
        ...
        Dim sqlrestdate As String = String.Format(
                                    ...
                                    " DATEADD(second, 0, " +
                                                ...
                                                " DATEADD(month, month([HolidayDate])-1, " +
                                                " DATEADD(Year, year([HolidayDate])-1900, 0)))))) AS ToDate " +
                                    " FROM FPICS_HolidayDate where [HolidayDate]>=getdate() and HolidayDate<=@EndDate and (IsHoliday=1 {0}) ",
