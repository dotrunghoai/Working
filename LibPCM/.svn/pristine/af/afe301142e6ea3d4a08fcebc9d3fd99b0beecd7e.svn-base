...
Public Class FrmOutTrayAndU00PR : Inherits DockContent
    ...
    Private Sub cboPdCode_Validating()
        ...
        If dt.Rows.Count <> 0 Then
            ...
            Dim sql3M As String = String.Format("select JCode, PdCode, round((sum(MatQty1) + sum(MatQty2)+ sum(MatQty3))/ 3, 2) as AVGUsing " +
            "from {0} " +
            ...
            Dim sql0131 As String = String.Format("select JCode, PdCode, round((sum(MatQty1) + sum(MatQty2)+ sum(MatQty3)), 2) as Total0131 " +
            "from {0} " +
