 ...
 Public Class PCM_NotJCode
    ...
    Public NormWeek As Decimal
    Public NormMonth As Decimal
    Public AddDtbtQty As Decimal 
     Public Qty1 As Decimal 
     Public Qty2 As Decimal 
     Public Qty3 As Decimal 
     Public Adjust As Decimal 
     Public ActReceive As Decimal 
     Public NgaySuDung As String 
     Public Note As String 
     Public RequestQty As Decimal 
     Public RequestDate As DateTime 
     Public ReviseQty As  Integer 
