...
Public Class FrmFG : Inherits DevExpress.XtraEditors.XtraForm

    Dim _db As New DBSql(PublicConst.EnumServers.NDV_SQL_ERP_NDV)


    Private Sub mnuShowAll_Click(sender As Object, e As EventArgs) Handles mnuShowAll.Click
        Dim sql As String = String.Format("sp_PLM_LoadFG")
    ...
    Private Sub dtpTuan_ValueChanged(sender As Object, e As EventArgs) Handles dtpTuan.ValueChanged
        dtpTuan.Value = GetFirstDayOfWeek(dtpTuan.Value.Date)
    End Sub

    Private Sub FrmFG_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
